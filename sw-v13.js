const CACHE = 'habit-companion-v13';
const ASSETS = ['./', './index.html', './styles.css?v=13', './icon-picker.css?v=13', './db.js?v=13', './app.js?v=13', './week-sunday.js?v=13', './momentum-period.js?v=13', './icons-ui.js?v=13', './reminders-v12.js?v=13', './manifest.webmanifest', './icon.svg'];
