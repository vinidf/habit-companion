const CACHE = 'habit-companion-v12';
const ASSETS = ['./', './index.html', './styles.css?v=12', './icon-picker.css?v=12', './db.js?v=12', './app.js?v=12', './week-sunday.js?v=12', './icons-ui.js?v=12', './reminders-v12.js?v=12', './manifest.webmanifest', './icon.svg'];
